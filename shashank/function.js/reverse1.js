...
// function reverse(shoes) {
//     for (i = shoes.length - 1; i >= 0; i--) {
//         result = console.log(shoes[i])
//     }

// }
// return reverse(shoes)


function reverseJson(shoes) {
    for (i = shoes.length - 1; i >= 0; i--) {
        console.log((shoes[i]))
...
return reverseJson(shoes)

function reverseProerty(shoes) {
