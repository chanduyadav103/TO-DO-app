...
for (const mobile of mobiles) {
    ...
    console.log(` specifications: ${mobile.specifications}`)
    for (let specification in mobile.specifications) {
        console.log(`\t${specification}: ${mobile.specifications[specification]}`)
    }
    if (typeof mobile.specifications.display === "object" && mobile.specifications.display.length == undefined)
        for (let key in mobile.specifications.display) {
            console.log(`\t${key}: ${mobile.specifications.display[key]}`)
        }
    else {
        console.log(`\t${specification}: ${mobile.specifications.display[specification]}`)
    }

}
console.log(`features : ${mobiles.features}`)
console.log(`ratings : ${mobiles.ratings}`)
console.log(`availability : ${mobiles.availability}`)
console.log("--------------------------------------------------");
